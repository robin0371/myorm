...
class TestCreate:
    ...
    def test_no_active(self, sqlite_clean):
    ...
    def test_incorrect_db(self, sqlite_clean):
        user = User(name="John Doe", is_active=True, created_at=datetime.date.today())
...
class TestRead:
    def test_get_all(self, sqlite_clean):
    ...
    def test_get_first(self, sqlite_clean):
    ...
    def test_get_last(self, sqlite_clean):
