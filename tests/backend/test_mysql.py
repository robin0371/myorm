...
class TestCreate:
    ...
    def test_no_active(self, mysql_clean):
    ...
    def test_incorrect_db(self, mysql_clean):
        user = User(name="John Doe", is_active=True, created_at=datetime.date.today())
...
class TestRead:
    def test_get_all(self, mysql_clean):
    ...
    def test_get_first(self, mysql_clean):
    ...
    def test_get_last(self, mysql_clean):
